...
int main()
{
	...
	short numberDay = NumberOfDaysFromBegningTheYear(Year, Month, Day);

	cout << "Number Of Days From Begning The Year is: " << numberDay << endl;

	sDate Date;

	Date = GetDateFromDayOrderInYear(numberDay, Year);
